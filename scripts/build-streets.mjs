 ...
 *
 *   npm run streets      NYC Open Data  ->  src/lib/streets-data.js
 *
 ...
 * streets.
 *
 * The geometry is projected into the same 1000x1000 frame as src/lib/city.js
...
export const ST={n:${JSON.stringify([...names.keys()])},d:${JSON.stringify(d)},q:${Q}};
`
await writeFile(new URL('src/lib/streets-data.js', root), payload)
console.log(`src/lib/streets-data.js — ${lines.length} polylines, ${names.size} names, ${(payload.length / 1024) | 0} KB`)
